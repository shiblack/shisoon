...
namespace Model
{
    ...
    [BindTable("UserConnect", Description = "用户链接。第三方绑定", ConnName = "Model", DbType = DatabaseType.SqlServer)]
    public partial class UserConnect : IUserConnect
    {
        ...
        [BindColumn("Provider", "提供商", "nvarchar(50)")]
        ...
        [DataObjectField(false, false, true, 50)]
        [BindColumn("OpenID", "身份标识。用户名、OpenID", "nvarchar(50)")]
        ...
        [DataObjectField(false, false, false, 0)]
        [BindColumn("LinkID", "用户编号。第三方用户编号", "bigint")]
        ...
        [BindColumn("AccessToken", "访问令牌", "nvarchar(500)")]
        ...
        [Description("刷新令牌")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn("RefreshToken", "刷新令牌", "nvarchar(500)")]
        ...
        [BindColumn("Expire", "过期时间", "datetime", Precision = 0, Scale = 3)]
