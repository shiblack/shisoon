...
{
    /// <summary></summary>
    public partial class ValveEquipment : Entity<ValveEquipment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ValveEquipment数据……", typeof(ValveEquipment).Name);

        //    var entity = new ValveEquipment();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ValveEquipment数据！", typeof(ValveEquipment).Name);
        //}
        #endregion
        ...
        public static ValveEquipment FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<ValveEquipment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
