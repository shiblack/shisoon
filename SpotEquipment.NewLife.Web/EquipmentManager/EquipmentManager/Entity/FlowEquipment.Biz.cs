...
namespace NewLife.Cube.Entity
{
    ...
    public partial class FlowEquipment : Entity<FlowEquipment>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}FlowEquipment数据……", typeof(FlowEquipment).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}FlowEquipment数据！", typeof(FlowEquipment).Name);
        //}
        #endregion
