...
namespace NewLife.Cube.Entity
{
    ...
    public partial class FaultEquipment : Entity<FaultEquipment>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}FaultEquipment数据……", typeof(FaultEquipment).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}FaultEquipment数据！", typeof(FaultEquipment).Name);
        //}
        #endregion
        ...
        //public static EntityList<FaultEquipment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
