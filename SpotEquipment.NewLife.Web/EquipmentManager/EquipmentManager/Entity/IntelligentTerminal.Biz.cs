...
namespace NewLife.Cube.Entity
{
    ...
    public partial class IntelligentTerminal : Entity<IntelligentTerminal>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}IntelligentTerminal数据……", typeof(IntelligentTerminal).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}IntelligentTerminal数据！", typeof(IntelligentTerminal).Name);
        //}
        #endregion
        ...
        //public static EntityList<IntelligentTerminal> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
