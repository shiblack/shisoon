...
{
    /// <summary></summary>
    public partial class SpareManagment : Entity<SpareManagment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}SpareManagment数据……", typeof(SpareManagment).Name);

        //    var entity = new SpareManagment();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}SpareManagment数据！", typeof(SpareManagment).Name);
        //}
        #endregion
        ...
        public static SpareManagment FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<SpareManagment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
