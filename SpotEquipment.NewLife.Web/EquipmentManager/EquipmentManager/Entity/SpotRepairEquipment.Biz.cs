...
{
    /// <summary></summary>
    public partial class SpotRepairEquipment : Entity<SpotRepairEquipment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}SpotRepairEquipment数据……", typeof(SpotRepairEquipment).Name);

        //    var entity = new SpotRepairEquipment();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}SpotRepairEquipment数据！", typeof(SpotRepairEquipment).Name);
        //}
        #endregion
        ...
        public static SpotRepairEquipment FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<SpotRepairEquipment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
