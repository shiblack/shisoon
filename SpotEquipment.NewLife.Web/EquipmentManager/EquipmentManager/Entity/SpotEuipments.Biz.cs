...
namespace NewLife.Cube.Entity
{
    ...
    public partial class SpotEuipments : Entity<SpotEuipments>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}SpotEuipments数据……", typeof(SpotEuipments).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}SpotEuipments数据！", typeof(SpotEuipments).Name);
        //}
        #endregion
        ...
        //public static EntityList<SpotEuipments> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
