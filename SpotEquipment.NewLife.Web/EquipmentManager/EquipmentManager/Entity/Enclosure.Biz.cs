...
{
    /// <summary></summary>
    public partial class Enclosure : Entity<Enclosure>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Enclosure数据……", typeof(Enclosure).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Enclosure数据！", typeof(Enclosure).Name);
        //}
        #endregion
        ...
        public static Enclosure FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<Enclosure> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
